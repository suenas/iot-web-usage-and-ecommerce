...
\begin{figure}[H]
  \centering
  \subfloat[Category Page with Display Mode PAGE]{{\includegraphics[width=8cm]{images/diagrams/before/desktop-category1.png} }}%
  \qquad
  \subfloat[Category Page with Display Mode PRODUCTS]{{\includegraphics[width=8cm]{images/diagrams/before/desktop-category2.png} }}%

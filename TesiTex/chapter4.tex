...
\subsubsection{Madison Island Homepage}

\vspace{0.5cm}
\begin{figure}[H]
  \centering
    \includegraphics[width=10cm]{images/diagrams/before/desktop-homepage.png}
...
\subsubsection{Madison Island Category Page}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=10cm]{images/diagrams/before/ifml-hierarchy-category.png}

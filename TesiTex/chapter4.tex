...
\subsubsection{Madison Island Product Page}
...
As per shown in \ref{fig:ifml-before-hierarchy-product}, the Interaction Flow model representing the product page has the following form:

...
Once the shoppers leaves the retail store the app performs a single data push to a listening web server with all the tracked data.
...
The transmitted data would eventually have this structure in JSON notation:
